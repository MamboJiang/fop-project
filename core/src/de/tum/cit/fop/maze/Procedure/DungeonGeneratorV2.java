...
public class DungeonGeneratorV2 {
    ...
    public List<GameObject> generate(int difficulty, boolean isBossLevel) {
        ...
        // 3x3 Grid with PADDING for external rooms
        // Grid uses 72x72 area (3 * 24).
        // 100x100 map. Offset 14.
        // Increased for longer corridors
        int slotSize = 24;
        int gridW = 3;
        int gridH = 3;
        ...
        boolean reverse = MathUtils.randomBoolean(); // Randomize direction
        ...
        // V10: Consistent Distance. Place exactly 1 slotSize away from Entry Grid
        // Center.
        ...
        // V10: Consistent Distance. Place exactly 1 slotSize away from Exit Grid
        // Center.
    ...
    private void connectGridRooms(Room r1, Room r2) {
        ...
        if (cx1 == cx2) { // Vertical
            ...
            // Also ensure connection into the room (in case padding was huge) -> Actually
            // carveRoom handles inside.
    ...
    private List<GameObject> placeObjects(int difficulty, boolean isBossLevel) {
        ...
        // Enemies & Traps (Skip Start and End Rooms for safety in Boss level? Maybe End
        // room has minions?)
    ...
    private void fillRoom(Room r, List<GameObject> objects, boolean[][] occupied, int enemies, int traps) {
        for (int j = 0; j < enemies; j++) {
            ...
            if (isGhost) {
                objects.add(new GhostSpawnPoint(pos.x * 16, pos.y * 16, 16, 16,
                        MapLoader.getMobAnimations(2, 1)[0].getKeyFrame(0)));
            } else {
                objects.add(new EnemySpawnPoint(pos.x * 16, pos.y * 16, 16, 16,
                        MapLoader.getMobAnimations(0, 0)[0].getKeyFrame(0)));
            }
        }
