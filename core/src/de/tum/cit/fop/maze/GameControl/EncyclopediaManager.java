...
public class EncyclopediaManager {
    ...
    private void loadEntries() {
        addEntry("main_character", "The Player", "The Runner. She woke up with no memory, knowing only that she must run. The lab's layout feels inexplicably familiar. Maybe it's talent, or maybe... this isn't the first time she has tried to run.", "player/lihui/maincharacterlhupscale.png");
